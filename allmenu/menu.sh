...
Name=$(curl -sS https://raw.githubusercontent.com/bukhorimukhammad/VPN/main/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/bukhorimukhammad/VPN/main/izin | grep $MYIP | awk '{print $3}')
